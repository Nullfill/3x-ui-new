...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/Nullfill/3x-ui-new/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/Nullfill/3x-ui-new/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/Nullfill/3x-ui-new/releases/tags/" + tag
	}
