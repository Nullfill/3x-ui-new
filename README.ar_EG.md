...
لتثبيت إصدار محدد، أضِف وسمه:

```bash
bash <(curl -Ls https://raw.githubusercontent.com/Nullfill/3x-ui-new/main/install.sh) v3.4.2-multiplier-1
```

## مُضاعِف استخدام حركة المرور

يُطبَّق المضاعف على حركة المرور المستقبلية فقط، ولا يغيّر عدادات الاستخدام السابقة. يمكن للمسؤول ضبط معامل صحيح أو عشري، وتكون الميزة معطلة افتراضيًا.
